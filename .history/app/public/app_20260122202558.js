let map;
let markers = [];
let currentPoiId = null;      // ID du POI sélectionné
let editingReviewId = null;   // ID de l'avis en édition
...
// =====================
// Recherche d'une ville et affichage des POI
// =====================
function searchCity() {
...
function renderResults(data) {
    ...
    // Affichage maximum 10 POI par catégorie
...
// =====================
// Chargement et affichage des avis d'un POI
// =====================
